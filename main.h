...
void checkprecision(char **str, int *type, int *precision, int *i,
		int *size, char *sign, int *base, char *c, char *locase);
int customspecifiers1(const char **fmt, char **str, va_list args,
		int *flags, int *field_width, int *precision, int *len);
